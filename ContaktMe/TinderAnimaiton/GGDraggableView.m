...
- (id)initWithFrame:(CGRect)frame
{
    ...
    [Functions fillContainerView:self WithView:self.overlayView];
...
- (void)loadImageAndStyle
{
    ...
    [Functions fillContainerView:self WithView:imageView];
...
- (void)dragged:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateChanged:{
            CGFloat rotationStrength = MIN(xDistance / self.frame.size.width, 1);
